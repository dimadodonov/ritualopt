...
<div class="cart__wrap">
	<form class="woocommerce-cart-form cart__form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
		...
		<div class="cart__forms shop_table shop_table_responsive cart woocommerce-cart-form__contents">
					...
					if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
						...
						<div class="cart-item woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
							...
							<div class="cart-inner">
								...
								<div class="cart-price-one" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
									<?php
								...
								<div class="cart-remove product-remove">
									<?php
				...
				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">
						<div class="coupon__wrap">
							<label for="coupon_code"><?php esc_html_e( 'Coupon:', 'woocommerce' ); ?></label> <input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'woocommerce' ); ?>" /> <button type="submit" class="button btn btn-black btn-solid" name="apply_coupon" value="<?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?>"><?php esc_attr_e( 'Apply coupon', 'woocommerce' ); ?></button>
